<%@ Page Title="" Language="C#" MasterPageFile="~/admin/user.master" AutoEventWireup="true" CodeFile="faq_update.aspx.cs" Inherits="admin_faq_update" %>
    ...
    <table style="width:100%;">
        ...
        <tr>
            ...
            <td style="width: 580px">
                    ...
                    <asp:Label ID="lblfaq_no" runat="server" Text="lblfaq_no" Visible="False"></asp:Label>
                </td>
        </tr>
        <tr>
